  ...
  const renderMobile = () => (
    <div className="our-products">
      <div className="our-products-container-m">
        <div className="our-products-title">Các dự án của chúng tôi</div>
        <div className="our-products-sub-title">
          Cùng xem cách mà khách hàng của chúng tôi biến đổi ngôi nhà của họ tới
          các sản phẩm mành, cửa chớp và màn cửa được may đo riêng.
        </div>
